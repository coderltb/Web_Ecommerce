...
public static class Web_ECommerceAdminPermissions
{
    public const string SystemGroupName = "WebEcomAdminSystem";
    public const string CatalogGroupName = "WebEcomAdminCatalog";
