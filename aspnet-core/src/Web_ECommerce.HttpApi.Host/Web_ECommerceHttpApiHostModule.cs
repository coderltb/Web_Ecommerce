...
[DependsOn(
    typeof(Web_ECommerceHttpApiModule),
...
public class Web_ECommerceHttpApiHostModule : AbpModule
{
    ...
    private void ConfigureVirtualFileSystem(ServiceConfigurationContext context)
    {
        ...
        if (hostingEnvironment.IsDevelopment())
        {
            Configure<AbpVirtualFileSystemOptions>(options =>
            {
                ...
                options.FileSets.ReplaceEmbeddedByPhysical<Web_ECommerceApplicationContractsModule>(
                    Path.Combine(hostingEnvironment.ContentRootPath,
                        $"..{Path.DirectorySeparatorChar}Web_ECommerce.Application.Contracts"));
                options.FileSets.ReplaceEmbeddedByPhysical<Web_ECommerceApplicationModule>(
                    Path.Combine(hostingEnvironment.ContentRootPath,
    ...
    private void ConfigureConventionalControllers()
    {
        ...
        {
            options.ConventionalControllers.Create(typeof(Web_ECommerceApplicationModule).Assembly);
        });
    }
