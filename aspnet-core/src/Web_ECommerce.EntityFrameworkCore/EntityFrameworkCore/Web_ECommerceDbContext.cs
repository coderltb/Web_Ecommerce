...
using Web_ECommerce.Configurations.Orders;
using Web_ECommerce.Configurations.ProductAttributes;
...
public class Web_ECommerceDbContext :
    AbpDbContext<Web_ECommerceDbContext>,
    IIdentityDbContext,
    ITenantManagementDbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
        ...
        //{
        //    b.ToTable(Web_ECommerceConsts.DbTablePrefix + "YourEntities", Web_ECommerceConsts.DbSchema);
