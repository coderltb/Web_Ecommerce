...
namespace Web_ECommerce.Admin.Catalog.Products
{
        ...
        CreateUpdateProductDto>, IProductsAppService
    {
        ...
        public ProductsAppService(IRepository<Product, Guid> repository,
            ...
            ProductCodeGenerator productCodeGenerator, IRepository<ProductAttribute> productAttributeRepository, IRepository<ProductAttributeDateTime> productAttributeDateTimeRepository, IRepository<ProductAttributeDecimal> productAttributeDecimalRepository, IRepository<ProductAttributeInt> productAttributeIntRepository, IRepository<ProductAttributeVarchar> productAttributeVarcharRepository, IRepository<ProductAttributeText> productAttributeTextRepository)
            : base(repository)
        {
        ...
        public override async Task<ProductDto> UpdateAsync(Guid id, CreateUpdateProductDto input)
        {
            ...
            if (product == null)
                throw new BusinessException(Web_ECommerceDomainErrorCodes.ProductIsNotExists);
        ...
        public async Task<ProductAttributeValueDto> AddProductAttributeAsync(AddUpdateProductAttributeDto input)
        {
            ...
            if (attribute == null)
                throw new BusinessException(Web_ECommerceDomainErrorCodes.ProductAttributeIdIsNotExists);
            ...
            switch (attribute.DataType)
            {
                case AttributeType.Date:
                    ...
                    {
                        throw new BusinessException(Web_ECommerceDomainErrorCodes.ProductAttributeValueIsNotValid);
                    }
